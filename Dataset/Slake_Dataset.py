...
class Slake_Dataset(Dataset):
    def __init__(self,  csv_path, tokenizer_path, img_dir='/data/workspace/zhangqingchuan/medllm/PMC-VQA/MedVInT_TD/Data/Slake1.0/imgs/',img_tokens = 32, seq_length = 512,voc_size = 32000, mode = 'Train',start = 0,text_type = 'blank'):
